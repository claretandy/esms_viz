...
ukcp18_ts = pd.read_csv('/home/h04/abradley/PycharmProjects/Specified-GWLs/Results/UKCP18_GWLs_Yearly_Temperature_2022_10_13-10:28:31_AM.csv')
ukcp18_ts.drop(columns='Unnamed: 0', inplace=True)
ukcp18_ts['Ensemble_Name'] = 'UKCP18'
cmip5_ts = pd.read_csv('/home/h04/abradley/PycharmProjects/Specified-GWLs/Results/CMIP5_GWLs_Yearly_Temperature_2022_10_20-09:11:50_AM.csv')
# cmip5_ts = pd.read_csv('/home/h04/abradley/PycharmProjects/Specified-GWLs/Results/CMIP5_GWLs_Yearly_Temperature_2022_09_15-04:00:34_PM.csv')
cmip5_ts.drop(columns='Unnamed: 0', inplace=True)
cmip5_ts['Ensemble_Name'] = 'CMIP5'
# cmip6_ts = pd.read_csv('/home/h04/abradley/PycharmProjects/Specified-GWLs/Results/CMIP6_GWLs_Yearly_Temperature_2022_09_13-10:25:19_PM.csv')
cmip6_ts = pd.read_csv('/home/h04/abradley/PycharmProjects/Specified-GWLs/Results/CMIP6_GWLs_Yearly_Temperature_2022_10_14-10:48:48_PM.csv')
